...
# for one SAMPLE
# echo SAMPLE=EE87892
#python /mnt/DATA3/timo/scripts/extractReadStartsFromBAM_Region_WPS_modified.py --minInsert=120 --maxInsert=180 -i /mnt/DATA3/timo/data/annotation_files/final_annotation_file.tsv -o "body/$SAMPLE/counts/block_%s.tsv.gz" /mnt/DATA3/timo/pipeline/BAM/True25630XA/$SAMPLE.sortByCoord.bam

# for all samples
# find body -mindepth 1 -maxdepth 1 -type d | sed 's|^body/||' parallel --progress --eta --tmpdir /mnt/DATA3/timo/main/tmp/ -j 30 -I{} \
# time python /mnt/DATA3/timo/scripts/data_pre-processing_Snyder/1_extractReadStartsFromBAM_Region_WPS_modified.py \
# --minInsert=120 \
# --maxInsert=180 \
# -i /mnt/DATA3/timo/data/annotation_files/final_annotation_file.tsv \
# -o "body/{}/counts/block_%s.tsv.gz" \
# /mnt/DATA3/timo/pipeline/BAM/True25630XA/{}.sortByCoord.bam
